...
function powerup:update()
	...
	elseif self:collides(player) then
		...
		if not self.no_points then
			add_actor(points_marker:new({x = self.x+5, y = self.y+3, value = 1}))
		end
...
function draw_title_screen()
	--cls()
	sspr(0,64,128,64,0,0)
	centre_pr("high scores", 64, 72, 7)
	for i=1,5 do
...

...

...

